...
}]Message has correct E\-O\-M. \index{Check\-Fail@{Check\-Fail}!Terra\-Swarm\-::\-Message\-Ender@{Terra\-Swarm\-::\-Message\-Ender}}\index{Terra\-Swarm\-::\-Message\-Ender@{Terra\-Swarm\-::\-Message\-Ender}!Check\-Fail@{Check\-Fail}}\item[{\em 
...
}]Message has incorrect E\-O\-M. \end{description}
\end{Desc}


Definition at line 53 of file Message\-Ender.\-h.
...
}]The only defined E\-O\-M value. \end{description}
\end{Desc}


Definition at line 31 of file Message\-Ender.\-h.
...
}]Size of the E\-O\-M field. \end{description}
\end{Desc}
...
Checks the E\-O\-M field for the correct value. 
...
Sets the E\-O\-M field to its value. 
