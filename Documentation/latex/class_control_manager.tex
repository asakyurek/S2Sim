...
{\em client\-Id} & Unique client id of the responding client. \\
\hline
{\em number\-Of\-Data\-Points} & Number of consumption points sent. \\
\hline
{\em data\-Points} & Buffer for the consumption points. \\
\hline
\end{DoxyParams}
...
\begin{DoxyParams}{Parameters}
{\em client\-Id} & Unique client id of the requesting client. \\
\hline
\end{DoxyParams}
...
\item[\hyperlink{todo__todo000005}{Todo}]Let's make this not inline for debugging.\end{DoxyRefDesc}



\begin{DoxyParams}{Parameters}
{\em client\-Id} & Unique client id for the requested object.\\
\hline
\end{DoxyParams}
...
Definition at line 296 of file Control\-Manager.\-h.
...
\item System mode.
\item System time.
\item For each client\-:
\begin{DoxyItemize}
\item Client unique id
\item Client terminal voltage 
\end{DoxyItemize}
\end{DoxyItemize}
...
\begin{DoxyParams}{Parameters}
{\em client\-Id} & Unique client id of the broken connection. \\
\hline
\end{DoxyParams}


Definition at line 259 of file Control\-Manager.\-h.
...
\begin{DoxyRefDesc}{Todo}
\item[\hyperlink{todo__todo000003}{Todo}]This doesn't need to be inline. \end{DoxyRefDesc}
